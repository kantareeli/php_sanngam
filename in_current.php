...
if (strlen($ndesc)>=355){		$ndesc=substr($ndesc,0,400)."   <A HREF='in_current_detail.php?newsID=".$Id."' class=newlinkPink >อ่านต่อ</A>...";}
//Set Display Update time 
		...
		<?if ($inicount%2==0){ $bgcolor="fcd5f6"; $picalign="right";}else{$bgcolor="FFFFFF"; $picalign="left";}?>
