...
<table width="993" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
  ...
  <tr>
    <td width="61">&nbsp;</td>
    <td width="698" align="left"><img src="images/BeautyGrandsale.gif"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
include("backoffice/manage/c_access.php");
    $sqlgrandsale = "select  *  from grandsale ORDER BY  gaOrder ASC";
...
//Set Display Update time 
		...
		<?if ($inicount%2==0){ $bgcolor="e4f4fb"; $picalign="right";}else{$bgcolor="FFFFFF"; $picalign="left";}?>
								...
								<STRONG><a name="<?=$Id?>"></a><?=$ntittle?></STRONG><BR><?if (isset($nPicture) and $nPicture<>''){?><A HREF="images/grandsalefile/<?=$nPicture?>" target="imagepop"><IMG 
                                alt="คลิ๊กเพื่อดูขนาดจริง" hspace=5 
                                src="images/grandsalefile/<?=$nPicture?>" 
