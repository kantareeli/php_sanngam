...
include("../../initial/connect.php");
	$sqlcount = "select  count(*) CC  from tbl_marquee ";
...
if (isset($mode) && ($mode=="MOVEUP")) {	
	$sqlA = "select  gaOrder  from tbl_marquee  where   Id ='$f_id'";
	//echo $sqlA."<BR>";
	...
	$sqlB = "select  Id  from tbl_marquee  where   gaOrder ='$FAQ_ORDER'";	
	//echo  $sqlB."<BR>";
	...
	$sql1 = "update  tbl_marquee set gaOrder=gaOrder-1  where   Id ='$f_id'"; 
	//echo  $sql1."<BR>";
	$updatestmt1 = mysql_query($sql1 ) or die ("Invalid query sql1 : " . mysql_error());

	$sql2 = "update  tbl_marquee set gaOrder=gaOrder+1 where   Id ='$Id_upper'"; 
	//echo  $sql2."<BR>";
...
<!-- 													<td align="center"><FONT FACE="ms sans serif" SIZE="1" COLOR="#FFFFFF"><B>ภาพประกอบ</B></FONT></td> -->
	<td align="center"><FONT FACE="ms sans serif" SIZE="1" COLOR="#FFFFFF"><B>หัวข้อ Marquee</B></FONT></td>
...
<?
	...
	$sql = "select  *  from tbl_marquee ORDER BY  gaOrder";
