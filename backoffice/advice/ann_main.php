...
include("../../initial/connect.php");
	$sqlcount = "select  count(*) CC  from advice ";
...
if (isset($mode) && ($mode=="MOVEUP")) {	
	$sqlA = "select  gaOrder  from advice  where   Id ='$f_id'";
	//echo $sqlA."<BR>";
	...
	$sqlB = "select  Id  from advice  where   gaOrder ='$FAQ_ORDER'";	
	//echo  $sqlB."<BR>";
	...
	$sql1 = "update  advice set gaOrder=gaOrder-1  where   Id ='$f_id'"; 
	//echo  $sql1."<BR>";
	$updatestmt1 = mysql_query($sql1 ) or die ("Invalid query sql1 : " . mysql_error());

	$sql2 = "update  advice set gaOrder=gaOrder+1 where   Id ='$Id_upper'"; 
	//echo  $sql2."<BR>";
