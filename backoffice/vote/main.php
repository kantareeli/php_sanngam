                    ...
                    <tr> 
                      <td><!-- InstanceBeginEditable name="topic" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td class="hp">Vote Management</td>
                          </tr>
                        </table>
...
<FORM action="main.php" method=post  name= 'frmmain' id='frmmain' enctype="multipart/form-data">
     ...
     <? 
 		$sWhere = ""; 
		$str = "select  *  from  tbvote order by ID desc";
		$rs = mysql_query($str);
?>
                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                  <tr valign="middle"> 
                                    <td width="7%" align="center" bgcolor="#7AA0BA"> ID</td>
                                    <td width="50%" align="center" bgcolor="#7AA0BA">Vote Subject</td>
...
?>
                                  <tr bgcolor=<?echo $col?>> 
									...
									<td><? echo $row[vSubject]; ?></td>
                                    
									<td align="center">&nbsp;<FONT FACE="ms sans serif" SIZE="1" COLOR="#000000">
										<input type="checkbox" name="checkbox1"  <?if ($row[vReEnable] == '1'){ print "checked";?>	onclick='disableit(<?print $row[ID]?>)' <?}else {?>onclick='enableit(<?print $row[ID]?>)' <?}?>></FONT></td>
