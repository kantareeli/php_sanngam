...
include("../../initial/connect.php");
	$sqlcount = "select  count(*) CC  from beautyalert ";
...
if (isset($mode) && ($mode=="MOVEUP")) {	
	$sqlA = "select  gaOrder  from beautyalert  where   Id ='$f_id'";
	//echo $sqlA."<BR>";
	...
	$sqlB = "select  Id  from beautyalert  where   gaOrder ='$FAQ_ORDER'";	
	//echo  $sqlB."<BR>";
	...
	$sql1 = "update  beautyalert set gaOrder=gaOrder-1  where   Id ='$f_id'"; 
	//echo  $sql1."<BR>";
	$updatestmt1 = mysql_query($sql1 ) or die ("Invalid query sql1 : " . mysql_error());

	$sql2 = "update  beautyalert set gaOrder=gaOrder+1 where   Id ='$Id_upper'"; 
	//echo  $sql2."<BR>";
...
<!-- 			<td align="center"><FONT FACE="ms sans serif" SIZE="1" COLOR="#000000">
			...
			<td align="left">&nbsp;<FONT FACE="ms sans serif" SIZE="1" COLOR="#000000"><B><?print $ntittle?>...</B></FONT>&nbsp;</td>
