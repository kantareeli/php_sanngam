...
include("../../initial/connect.php");
	$sqlcount = "select  count(*) CC  from clinicTop ";
...
if (isset($mode) && ($mode=="MOVEUP")) {	
	$sqlA = "select  gaOrder  from clinicTop  where   Id ='$f_id'";
	//echo $sqlA."<BR>";
	...
	$sqlB = "select  Id  from clinicTop  where   gaOrder ='$FAQ_ORDER'";	
	//echo  $sqlB."<BR>";
	...
	$sql1 = "update  clinicTop set gaOrder=gaOrder-1  where   Id ='$f_id'"; 
	//echo  $sql1."<BR>";
	$updatestmt1 = mysql_query($sql1 ) or die ("Invalid query sql1 : " . mysql_error());

	$sql2 = "update  clinicTop set gaOrder=gaOrder+1 where   Id ='$Id_upper'"; 
	//echo  $sql2."<BR>";
...
<?
	...
	$sql = "select  *  from clinicTop ORDER BY  gaOrder";
